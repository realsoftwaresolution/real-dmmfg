...
class CutCreateDetModel {
  ...
  Map<String, dynamic> toJson() => {
    ...
    if(out != null)'Out':              out,
    if (colorCode  != null && colorCode  != 0)   'ColorCode': colorCode,
    if (purityCode  != null && purityCode  != 0)   'PurityCode': purityCode,
    if (charniCode  != null && charniCode  != 0)   'CharniCode': charniCode,
