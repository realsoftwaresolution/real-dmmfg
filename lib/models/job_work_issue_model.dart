...
class JobWorkIssueMstModel {
  final int? jobWorkIssMstID;
  final String jobWorkIssDate;
  final String? time;
  ...
  const JobWorkIssueMstModel({
    this.jobWorkIssMstID,
    required this.jobWorkIssDate,
    this.time,
  ...
  factory JobWorkIssueMstModel.fromJson(Map<String, dynamic> json) {
    return JobWorkIssueMstModel(
  ...
  Map<String, dynamic> toJson() => {
    'JobWorkIssMstID': jobWorkIssMstID,
    'JobWorkIssDate': jobWorkIssDate,
...
class JobWorkIssueDetModel {
  final int? jobWorkIssDetID;
  final int? jobWorkIssMstID;
  final int? srno;
...
// IDs
  final int? polishCheckerIssMstID;
...
// Message
  ...
  const JobWorkIssueDetModel({
    this.jobWorkIssDetID,
    this.jobWorkIssMstID,
    this.srno,
    required this.cutNo,
  ...
  Map<String, dynamic> toJson() => {
    'JobWorkIssDetID': jobWorkIssDetID,
    'JobWorkIssMstID': jobWorkIssMstID,
    'Srno': srno,
    'CutNo': cutNo,
    'MfgCut': mfgCut,
    ...
    'PolishCheckerIssMstID': polishCheckerIssMstID,
...
class JobWorkIssuePayload {
  final String jobWorkIssDate;
  final int partyMstID;
  final int deptProcessCode;
  final String sflag;
  final int ever;
  final List<JobWorkIssueDetModel> details;

  const JobWorkIssuePayload({
    required this.jobWorkIssDate,
    required this.partyMstID,
    required this.deptProcessCode,
    required this.sflag,
...
/// Summary Model
class JobWorkIssueSummaryModel {
  final String partyName;
  ...
  final double totalDmWt;
  final double totalDmPer;
  final List<JobWorkIssSummaryRow> summary;

  const JobWorkIssueSummaryModel({
  ...
  factory JobWorkIssueSummaryModel.fromJson(Map<String, dynamic> json) {
    final data = json['data'] as Map<String, dynamic>? ?? {};
    return JobWorkIssueSummaryModel(
      ...
      summary: (data['summary'] as List<dynamic>? ?? [])
          .map((e) => JobWorkIssSummaryRow.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
  }
}

class JobWorkIssSummaryRow {
  final int srno;
  final String cutNo;
  final String mfgCut;
  final int pairNo;
