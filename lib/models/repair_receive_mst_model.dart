...
class RepairReceiveMstModel {
  ...
  factory RepairReceiveMstModel.fromJson(Map<String, dynamic> json) {
    return RepairReceiveMstModel(
      factoryRecMstID: json['RepairRecMstID'],
      factoryRecDate: _dateOnly(json['RepairRecDate']),
...
class RepairReceiveDetModel {
  ...
  const RepairReceiveDetModel({
    ...
    this.fColorCode2,
    this.ha,
    this.topSide, this.SellCode, this.SellAmount, this.SellRate, this.newRecMstId,
  });

  factory RepairReceiveDetModel.fromJson(Map<String, dynamic> json) =>
      RepairReceiveDetModel(
        factoryIssDetID: json['FactoryIssDetID'],
        factoryRecMstID:  json['RepairRecMstID'] ?? 0,
        newRecMstId:  json['NewRecMstID'] ?? json['NewRecMstId'] ?? 0,
        FactoryRecDetID:  json['RepairRecDetID'],
  ...
  Map<String, dynamic> toJson() => {
    ...
    'RepairRecMstID':  factoryRecMstID,
    'NewRecMstId':  newRecMstId,
    'RepairRecDetID':  FactoryRecDetID,
  ...
  RepairReceiveDetModel copyWith({
    int? factoryIssDetID,
    int? factoryRecMstID,
    int? FactoryRecDetID,
    int? newRecMstId,
    ...
    double? SellRate,
      ...
      RepairReceiveDetModel(
        ...
        newRecMstId: newRecMstId ?? this.newRecMstId,
        srno: srno ?? this.srno,
        id: id ?? this.id,
        jno: jno ?? this.jno,
...
extension RepairReceiveMstExt on RepairReceiveMstModel {
