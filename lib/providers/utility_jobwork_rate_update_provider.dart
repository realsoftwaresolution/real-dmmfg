...
class UtilityJobWorkRateUpdateProvider extends BaseProvider {
  List<JobWorkRateUpdateModel> recalculationData = [];
  ...
  Future<void> clvDeptRateUpdate(
    ...
    await request(
      showLoader: true,
      call: () => api.post('/jobWorkRec/recalculate-rates', data: formValues),
      onSuccess: (res) async {
        if (res.data['success'] == false) {
          ...
          recalculationData = (res.data['data'] as List<dynamic>)
              .map(
                (e) => JobWorkRateUpdateModel.fromJson(
